...
public class GameMemberRestController {
    ...
    public BaseResponse<GameMemberResponseDTO.RankResponseDTO> teamRank(@PathVariable("teamId")){
        return BaseResponse.onSuccess(GameMemberConverter.toRankResponseDTO())
    }
}
